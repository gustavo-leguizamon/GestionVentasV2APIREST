...
namespace GL.GestionVentas.Repositories.Migrations
{
    ...
    [Migration("20200613022659_ColumnaImagen")]
    partial class ColumnaImagen
    {
            ...
            modelBuilder.Entity("GL.GestionVentas.Domain.Entities.Ventas", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            VentasId = 1,
                            CarritoId = 1,
                            Fecha = new DateTime(2020, 6, 12, 23, 26, 58, 438, DateTimeKind.Local).AddTicks(4740)
                        },
                        new
                        {
                            VentasId = 2,
                            CarritoId = 2,
                            Fecha = new DateTime(2020, 6, 12, 23, 26, 58, 441, DateTimeKind.Local).AddTicks(479)
                        },
                        new
                        {
                            VentasId = 3,
                            CarritoId = 3,
                            Fecha = new DateTime(2020, 6, 12, 23, 26, 58, 441, DateTimeKind.Local).AddTicks(606)
                        });
                });
